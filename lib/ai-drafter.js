...
function validateDrafts(d) {
  ...
  const banned = ['guaranteed', 'guarantees', 'proven', 'ensures', 'cures', 'treats', 'diagnoses', 'Emily', 'RDN', 'prescription', 'prescriptive', 'clinical', 'therapeutic', 'miracle', 'breakthrough'];
